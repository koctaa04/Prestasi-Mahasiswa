            ...
            <ul>
              <div class="d-flex flex-column justify-content-center" width="10px">
                <ul>
                  ...
                  <li><a class="nav-link active" href="../pages/Kelola-Juara.html"> Kelola Juara</a></li>
                </ul>
              </div>
            </ul>
          </li>
                ...
                <div class="card-body pt-4 p-3">
                  ...
                  <form>
                    ...
                    <div class="form-group mt-3">
                      ...
                      <input type="text" class="form-control" id="nama" placeholder="Masukkan Kejuaraan">
                    </div>
                    <div class="form-group mt-3">
                      ...
                      <table class="table table-striped table-hover table-bordered align-items-center mb-0">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td class="text-center align-middle"><p class="text-xs font-weight-bold mb-0">Harapan 1</p></td>
