...
<html lang="en">
  ...
  <body class="g-sidenav-show bg-gray-100">
    ...
    <main class="main-content position-relative border-radius-lg">
      ...
      </nav><div class="border-radius-xl mt-4 mx-4 position-relative" style="background-color: rgb(35, 35, 73);">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header pb-0 px-3">
                  <h6 class="mb-0">Tambah Tingkatan</h6>
                </div>
                <div class="card-body pt-4 p-3">
                  ...
                  <form>
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="namaLomba" placeholder="Masukkan ID">
                    </div>
                    <div class="form-group mt-3">
                      <label for="tanggalLomba">Tingkatan</label>
                      <input type="text" class="form-control" id="nama" placeholder="Masukkan Tingkatan">
                    </div>
                    <div class="form-group mt-3">
                      <label for="tanggalLomba">Point</label>
                      <input type="text" class="form-control" id="nama" placeholder="Masukkan Point">
                    </div>
                  ...
                  <div class="card-body pt-4 p-3">
                    <div class="table-responsive border-radius-lg">
                      <table class="table table-striped table-hover table-bordered align-items-center mb-0">
                        ...
                        <tbody>
                          <tr>
                            <td class="text-center align-middle"><p class="text-xs font-weight-bold mb-0">1</p></td>
                            <td class="text-center align-middle"><p class="text-xs font-weight-bold mb-0">Internasional</p></td>
                            <td class="text-center align-middle"><p class="text-xs font-weight-bold mb-0">50</p></td>
