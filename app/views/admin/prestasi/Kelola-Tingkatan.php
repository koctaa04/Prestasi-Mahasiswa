        ...
        <li class="nav-item">
          ...
          <ul>
            <div class="d-flex flex-column justify-content-center" width="10px">
              <ul>
                <li><a class="nav-link" href="../pages/Prestasi-terverifikasi.html">Prestasi yang terverifikasi</a></li>
                ...
                <li><a class="nav-link active" href="../pages/Kelola-Tingkatan.html"> Kelola Tingkatan</a></li>
      ...
      <div class="container-fluid py-1 px-">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Tingkatan</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Tingkatan</h6>
        </nav>
      ...
      <div class="container-fluid py-4">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header pb-0 px-3">
                <h6 class="mb-0">Tambah Tingkatan baru</h6>
              </div>
              <div class="card-body pt-4 p-3">
                <!-- Form submit info lomba -->
                <form action="index.php?controller=admin&action=addTingkatan" method="post">

                  <div class="form-group mt-3">
                    <label for="tanggalLomba">Tingkatam</label>
                    <input name="name_tingkatan" type="text" class="form-control" id="nama" required placeholder="Masukkan Tingkatan Lomba">
                  </div>
                  <div class="form-group mt-3">
                    <label for="tanggalLomba">Point</label>
                    <input name="poin_tingkatan" type="text" class="form-control" id="nama" required placeholder="Masukkan Point">
                  </div>
        ...
        <div class="row mt-4">
          <div class="col-12">
            <div class="card">
              <div class="card-header pb-0 px-3">
                <h6 class="mb-0">Kelola tingkatan</h6>
              </div>
              <div class="card-body pt-4 p-3">
                  ...
                  <table class="table table-striped table-hover table-bordered align-items-center mb-0">
                    <thead class="bg-primary">
                      <tr>
                        ...
                        <th class="text-white text-center align-middle text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tingkatan Lomba </th>
                      ...
                      <?php if (!empty($tingkatans)): ?>
                        ...
                        foreach ($tingkatans as $tingkatan): ?>
                          <tr>
                            ...
                            <td class="text-center align-middle">
                              <p class="text-xs font-weight-bold mb-0"><?= $tingkatan['nama'] ?></p>
                            </td>
                            <td class="text-center align-middle">
                              <p class="text-xs font-weight-bold mb-0"><?= $tingkatan['poin'] ?></p>
                            </td>

                            <td class="text-center align-middle">
                              <button type="button" class="btn btn-secondary bg-gradient-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modal-edit-verif-<?= $tingkatan['id'] ?>">Edit</button>
                              <div class="modal fade" id="modal-edit-verif-<?= $tingkatan['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="modal-edit-verif-<?= $tingkatan['id'] ?>" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      <form method="POST" action="index.php?controller=admin&action=editTingkatan">
                                        <div class="form-group">
                                          <label for="namaLomba">ID</label>
                                          <input type="text" name="id" class="form-control" id="namaLomba" value="<?= $tingkatan['id'] ?>" disabled>
                                          <input type="hidden" name="id" class="form-control" id="namaLomba" value="<?= $tingkatan['id'] ?>">
                                        </div>
                                        <div class="form-group mt-3">
                                          <label for="nama">Nama tingkatan</label>
                                          <input name="name_tingkatan" type="text" class="form-control" id="nama" value="<?= $tingkatan['nama'] ?>">
                                        </div>
                                        <div class="form-group mt-3">
                                          <label for="poin">Poin tingkatan</label>
                                          <input name="poin_tingkatan" type="text" class="form-control" id="poin" value="<?= $tingkatan['poin'] ?>">
                                        </div>
                                        <button type="submit" class="btn btn-primary mt-3">Submit</button>
                                      </form>
                                    </div>
                              ...
                              <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modal-hapus-<?= $tingkatan['id'] ?>">Delete</button>
                              <div class="modal fade" id="modal-hapus-<?= $tingkatan['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="modal-hapus-<?= $tingkatan['id'] ?>" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                  <div class="modal-content">
                                    <div class="modal-body">
                                      <h4>Anda yakin ingin menghapus data ini?</h4>
                                      <form action="index.php?controller=admin&action=deleteTingkatan" method="post">
                                        <div class="form-group">
                                          <label for="namaLomba">ID</label>
                                          <input type="text" name="id" class="form-control" id="namaLomba" value="<?= $tingkatan['id'] ?>" disabled>
                                        </div>
                                        <div class="form-group mt-3">
                                          <label for="tanggalLomba">Nama tingkatan</label>
                                          <input type="text" name="name_tingkatan" class="form-control" id="nama" value="<?= $tingkatan['nama'] ?>" disabled>
                                        </div>
                                        <input type="hidden" name="id" class="form-control" id="namaLomba" value="<?= $tingkatan['id'] ?>">
