          ...
          <ul>
            <div class="d-flex flex-column justify-content-center" width="10px">
              <ul>
                ...
                <li><a class="nav-link active" href="../pages/Kelola-Kategori.html"> Kelola Kategori</a></li>
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body pt-4 p-3">
                <form method="POST" action="index.php?controller=admin&action=addKategori">
                  <div class="form-group mt-3">
                    <label for="tanggalLomba">Kategori</label>
                    <input type="text" class="form-control" id="nama" placeholder="Masukkan nama Kategori" required name="name_kategori">
                  </div>
                      ...
                      <?php if (!empty($categories)): ?>
                        ...
                        foreach ($categories as $cat): ?>
                          <tr>
                            ...
                            <td class="text-center align-middle">
                              <p class="text-xs font-weight-bold mb-0"><?= $cat['nama'] ?></p>
                            </td>
