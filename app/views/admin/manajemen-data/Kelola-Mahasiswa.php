                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <input name="nim" type="text" class="form-control form-control-alternative" id="NIM" placeholder="Masukkan NIM">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <label for="nama">Nama Mahasiswa</label>
                    <div class="form-group">
                      <input name="nama" type="text" class="form-control form-control-alternative" id="nama" placeholder="Masukkan Nama Mahasiswa">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <div class="input-group input-group-alternative mb-4">
                        <input name="password" type="password" class="form-control form-control-alternative" id="password" placeholder="Masukkan Password">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <div class="input-group input-group-alternative mb-4">
                        <input name="program_studi" type="text" class="form-control form-control-alternative" id="program_studi" placeholder="Program Studi">
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group has-success">
                      <input name="jurusan" type="text" class="form-control form-control-alternative" id="Jurusan" placeholder="Jurusan">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <label for="Angkatan">Angkatan</label>
                    <div class="form-group has-danger">
                      <input name="angkatan" type="text" class="form-control form-control-alternative" id="Angkatan" placeholder="Angkatan">
                    </div>
                  </div>
                </div>
