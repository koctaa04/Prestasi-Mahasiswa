    ...
    <div class="container-fluid py-4">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Prestasi Terverifikasi</p>
                    <h6 class="font-weight-bolder">
                      <?= $totalPrestasiVerified ?> Prestasi
                    </h6>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Prestasi Belum Terferifikasi</p>
                    <h6 class="font-weight-bolder">
                      <?= $totalPrestasiUnverified ?> prestasi
                    </h6>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Informasi Lomba Belum Terverifikasi</p>
                    <h6 class="font-weight-bolder">
                      <?= $totalLombaUnverified ?> informasi lomba
                  </div>
                </div>
                <div class="col-4 text-end">
      ...
      <div class="row mt-4">
          ...
          <div class="card">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <h6 class="mb-2">Top 5 Mahasiswa</h6>
              </div>
            </div>
            <div class="table-responsive">
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  <?php foreach ($topMhs as $mhs): ?>

                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="app/views/assets/img/profile-mahasiswa.png" class="avatar avatar-sm me-3">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-xs"><?= $mhs['nama']; ?></h6>
                            <p class="text-xs text-secondary mb-0"><?= $mhs['nim']; ?></p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?= $mhs['prodi']; ?></p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?= $mhs['jurusan']; ?></p>
                      </td>
                      <td>
                        <p class="px-4 text-xs font-weight-bold mb-0"><?= $mhs['angkatan']; ?></p>
                      </td>
                      <td>
                        <p class="px-4 text-xs font-weight-bold mb-0"><?= $mhs['total_poin']; ?></p>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
        ...
        <div class="col-lg-5">
          <div class="card">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0">Kelola Data Prestasi Lomba</h6>
            </div>
            <div class="card-body p-3">
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      ...
                      <span class="text-xs">7 Jurusan --Belum ges</span>
                    </div>
                  </div>
                  <div class="d-flex">
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      ...
                      <span class="text-xs"><?= $totalTingkatan ?> Jenis tingkatan lomba</span>
                    </div>
                  </div>
                  <div class="d-flex">
                    <a href="" class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></a>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      ...
                      <span class="text-xs"><?= $totalKategori ?> Jenis kategori lomba</span>
                    </div>
                  </div>
                  <div class="d-flex">
                    <a href="" class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></a>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      ...
                      <span class="text-xs font-weight-bold"><?= $totalJuara ?> Jenis juara</span>
                    </div>
                  </div>
                  <div class="d-flex">
                    <a href="" class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></a>
    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Dashboard Option</h5>
