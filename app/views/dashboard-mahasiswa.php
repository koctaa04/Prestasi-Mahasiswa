            ...
            <ul class="navbar-nav justify-content-end">
              <li class="nav-item d-flex align-items-center">
                <a href="javascript:;" class="nav-link text-white font-weight-bold px-0">
                  ...
                  <span class="d-sm-inline d-none" href="index.php?controller=auth&action=login">Sign In</span>
                </a>
              </li>
      ...
      <div class="container-fluid py-4">
            ...
            <div class="card">
              <div class="card-body p-3">
                <div class="row">
                  <div class="col-8">
                    <div class="numbers">
                      <p class="text-sm mb-0 text-uppercase font-weight-bold">Prestasi Mahasiswa</p>
                      <h6 class="font-weight-bolder">
                        35 Prestasi yang diraih
                      </h6>
                    </div>
                  </div>
                  <div class="col-4 text-end">
            ...
            <div class="card">
              <div class="card-body p-3">
                <div class="row">
                  <div class="col-8">
                    <div class="numbers">
                      <p class="text-sm mb-0 text-uppercase font-weight-bold">Belum terferifikasi</p>
                      <h6 class="font-weight-bolder">
          ...
          <div class="col-lg-7 mb-lg-0 mb-4">
            <div class="card z-index-2 h-100">
              <div class="card-header pb-0 pt-3 bg-transparent">
                <h6 class="text-capitalize">Statistik Prestasi Mahasiswa</h6>
                <p class="text-sm mb-0">
                  <i class="fa fa-arrow-up text-success"></i>
                  <span class="font-weight-bold">Pada tahun ini</span>
                </p>
              </div>
              <div class="card-body p-3">
                <div class="chart">
                  <canvas id="chart-line" class="chart-canvas" height="flex"></canvas>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row mt-4">
            ...
            <div class="card">
              <div class="card-header pb-0 p-3">
                <div class="d-flex justify-content-between">
                  <h6 class="mb-2">Data Prestasi Mahasiswa</h6>
                </div>
              </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nama Lomba</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Juara</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Play IT</p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Juara 2</p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Nasional</p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Pending</p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">UI/UX Competition</p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-xs">Erik Ridho</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">4C Competition</p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Juara 2</p>
                      </td>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Software Developmnent</p>
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Hology</p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Juara 1</p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Nasional</p>
                      </td>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Web Design</p>
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div class="col-lg-5">
            <div class="card">
              <div class="card-header pb-0 p-3">
                <h6 class="mb-0">Kelola Prestasi Mahasiswa</h6>
              </div>
              <div class="card-body p-3">
                <ul class="list-group">
                  <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="d-flex flex-column">
                        <h6 class="mb-1 text-dark text-sm">Kelola Jurusan</h6>
                        <span class="text-xs">7 Jurusan</span>
                      </div>
                    </div>
                    <div class="d-flex">
                  ...
                  <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="d-flex flex-column">
                        <h6 class="mb-1 text-dark text-sm">Kelola Tingkatan</h6>
                        <span class="text-xs">3 Tingkatan lomba</span>
                      </div>
                    </div>
                    <div class="d-flex">
                      <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></button>
                  ...
                  <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <span class="text-xs">12 Kategori Lomba</span>
                      </div>
                    </div>
                    <div class="d-flex">
                      <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></button>
                  ...
                  <li class="list-group-item border-0 d-flex justify-content-between ps-0 border-radius-lg">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="d-flex flex-column">
                        <h6 class="mb-1 text-dark text-sm">Kelola Juara</h6>
                        <span class="text-xs font-weight-bold">6 Jenis Juara</span>
                      </div>
                    </div>
                    <div class="d-flex">
                      <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></button>
