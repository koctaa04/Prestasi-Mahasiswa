        ...
        <div class="row"> 
              ...
              <div class="card-body pt-4 p-3">
                ...
                <form>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="namaLomba" placeholder="Masukkan link lomba">
                  </div>
                  <div class="form-group mt-3">
                ...
                <div class="card-body pt-4 p-3">
                  <div class="table-responsive border-radius-lg">
                    <table class="table table-striped table-hover table-bordered align-items-center mb-0">
                      ...
                      <tbody>
                        <tr>
                          <td class="text-center align-middle"><p class="text-xs font-weight-bold mb-0">Kompetisi Nasional IT-CAS 2024</p></td>
                          <td class="text-center align-middle"><p class="text-xs font-weight-bold mb-0">2 Desember 2024</p></td>
                          <td class="text-center align-middle">
                            <button class="btn btn-link btn-sm">https://linkLomba1</button>
                          </td>
                          <td class="text-center align-middle">
                                      ...
                                      <div class="card-body">
                                        <form role="form text-left">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="linkLomba" placeholder="Masukkan link lomba">
                                          </div>
                                          <div class="form-group mt-3">
                                            <label for="uploadPamflet">Unggah Pamflet Lomba</label>
                                            <input type="file" class="form-control" id="uploadPamflet" accept="image/*">
                        ...
                        <tr>
                          <td class="text-center align-middle"><p class="text-xs font-weight-bold mb-0">FESTIDA 2024</p></td>
                          <td class="text-center align-middle"><p class="text-xs font-weight-bold mb-0">17 November 2024</p></td>
                          <td class="text-center align-middle">
                            <button class="btn btn-link btn-sm">https://linkLomba2</button>
                          </td>
                          <td class="text-center align-middle">
                            ...
                            <div class="modal fade" id="modal-lihatPamflet-2" tabindex="-1" role="dialog" aria-labelledby="modal-lihatPamflet-2" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                <div class="modal-content">
                                  <div class="modal-body p-0">
                                    <div class="card">
                                      <img src="../assets/img/img_lomba2.jpg" alt="Pamflet" class="img-fluid" />
                                    </div>  
                                  </div>
                                </div>
                              </div>
                          ...
                          <td class="text-center align-middle">
                            <button type="button" class="btn btn-secondary bg-gradient-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modal-edit-verif-2">Edit</button>
                              <div class="modal fade" id="modal-edit-verif-2" tabindex="-1" role="dialog" aria-labelledby="modal-edit-verif-2" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                  <div class="modal-content">
                                    <div class="modal-body p-0">
                                      <div class="card card-plain">
                            ...
                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modal-details-verif-2">Details</button>
                              <div class="modal fade" id="modal-details-verif-2" tabindex="-1" role="dialog" aria-labelledby="modal-details-verif-2" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h5 class="modal-title" id="modal-details-verif-2">Detail Info Lomba</h5>
                                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                      <p><strong>Nama Lomba:</strong> FESTIDA 2024</p>
                                      <p><strong>Tenggat Pendaftaran:</strong> 17 November 2024 </p>
                                      <p><strong>Link:</strong> <a href="https://linkLomba2" target="_blank">https://linkLomba2</a></p>
                                      <p><strong>Pamflet:</strong></p>
                                      <!-- Menampilkan Gambar Pamflet -->
                                      <img src="../assets/img/img_lomba2.jpg" alt="Pamflet" class="img-fluid" />
                                    </div>
          ...
          <div class="row mt-4">
            <div class="col-12">
              <div class="card">
                <div class="card-header pb-0 px-3">
                  <h6 class="mb-0">Info Lomba yang Ditolak</h6>
                </div>
                <div class="card-body pt-4 p-3">
                  <div class="table-responsive border-radius-lg">
                    <table class="table table-striped table-hover table-bordered align-items-center mb-0">
                      <thead class="bg-primary">
                        <tr>
                          ...
                          <th class="text-white text-center align-middle text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Link</th>
                          <th class="text-white text-center align-middle text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Pamflet</th>
                          <th class="text-white text-center align-middle text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Alasan</th>
                          <th class="text-white text-center align-middle text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Aksi</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td class="text-center align-middle"><p class="text-xs font-weight-bold mb-0">De Code Web Design Competition 2024</p></td>
                          <td class="text-center align-middle"><p class="text-xs font-weight-bold mb-0">30 Oktober 2024</p></td>
                          <td class="text-center align-middle">
                            <button class="btn btn-link btn-sm">https://linkLomba3</button>
                          </td>
                          <td class="text-center align-middle">
                            <button type="button" class="btn btn-secondary bg-info btn-sm" data-bs-toggle="modal" data-bs-target="#modal-lihatPamflet-3">Lihat Pamflet</button>
                            <div class="modal fade" id="modal-lihatPamflet-3" tabindex="-1" role="dialog" aria-labelledby="modal-lihatPamflet-3" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                <div class="modal-content">
                                  <div class="modal-body p-0">
                                    <div class="card">
                          ...
                          <td class="text-center align-middle"><p class="text-xs font-weight-bold mb-0">Pendaftaran telah ditutup</p></td>
                          <td class="text-center align-middle">
                            <button type="button" class="btn btn-secondary bg-gradient-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modal-edit-tolak-1">Edit</button>
                              <div class="modal fade" id="modal-edit-tolak-1" tabindex="-1" role="dialog" aria-labelledby="modal-edit-tolak-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                  <div class="modal-content">
                                    <div class="modal-body p-0">
                                      <div class="card card-plain">
                            ...
                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modal-details-tolak-1">Details</button>
                              <div class="modal fade" id="modal-details-tolak-1" tabindex="-1" role="dialog" aria-labelledby="modal-details-tolak-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h5 class="modal-title" id="modal-details-tolak-1">Detail Info Lomba</h5>
                                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
