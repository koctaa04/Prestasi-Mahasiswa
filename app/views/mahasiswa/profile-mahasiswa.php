    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4" id="sidenav-main">
      ...
      <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../pages/tambah-prestasi.html">
              <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="../pages/profile-mahasiswa.html">
              <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="row gx-4">
            <div class="col-auto">
              <div class="avatar avatar-xl position-relative">
                <img src="../assets/img/profile-mahasiswa.png" alt="profile_image" class="w-100 border-radius-lg shadow-sm" />
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="card card-profile">
              <img src="../assets/img/gedung.jpg" alt="Image placeholder" class="card-img-top" />
